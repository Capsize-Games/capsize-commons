...
| --- | --- | --- | --- |
| `capsize-commons` Python | `0.1.5` candidate | Python `>=3.11` | `python/pyproject.toml`, PyPI package metadata |
| `@capsizellc/commons` | `0.1.5` candidate | Node `>=22` | `typescript/package.json`, npm package metadata |
| C++ library | `0.1.5` candidate | C++23, CMake `>=3.24` | `cpp/CMakeLists.txt` and tagged source release |
...
The Python artifact `0.1.2` is published and verified. The `0.1.5` candidate
